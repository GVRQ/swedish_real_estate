...
file_path_bostadsratter = 'Svensk_Mäklarstatistik_Bostadsrätter_Riket_april2023.xlsx'
file_path_tabell = 'Svensk_Mäklarstatistik_Tabell_Riket_april2023.xlsx'
file_path_tabell_riket = 'Svensk_Mäklarstatistik_Tabell_Riket.xlsx'
file_path_utbud = 'utbud_lägenhet_sverige_23_04_07.xls'
